...
@ActiveProfiles("test")
public class PledgedLifeInsuranceServiceLevelEnd2EndTest extends AExternalRestCallsRequiringTest {
    ...
    public void testPrintRequestPost() {
        ...
        assertEquals( 6, omsRequests.getOmsRequests().size(), "expected 1 oms request" );
        ...
        assertEquals(3,  xmlTestUtils.countElement(xmlText,  "/ns:document/ns:content/ns:signatures/ns:signature"), "unexpected number of signatures/signature");
    ...
    private PrintRequest setupScenario1() {
        ...
        final PrintRequest printRequest4Test =
                fromJson(
                        readResourceFile("scenarios/scenario01/print_request02.json"),
                        PrintRequest.class
                );

        final UUID dossierId = printRequest4Test.getDossier().getDossierId();
        ...
        setupRestCallMocks(
                ...
                AExternalRestCallsRequiringTest.DeclareEndpointMock.as(
                        "scenarios/scenario01/jane_lifeinsurances.json",
                        AExternalRestCallsRequiringTest.EKnownEndpoints.GetLifeinsuranceCollaterals,
